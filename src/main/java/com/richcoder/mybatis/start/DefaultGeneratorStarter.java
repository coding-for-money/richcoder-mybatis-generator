...
import com.richcoder.mybatis.config.GeneratorConfigurer;
import com.richcoder.mybatis.config.GeneratorConfigurerFactory;
import com.richcoder.mybatis.config.PackageConfigTypes;
import com.richcoder.mybatis.connect.Connector;
import com.richcoder.mybatis.connect.MysqlConnector;
import com.richcoder.mybatis.generator.Generator;
import com.richcoder.mybatis.generator.context.GeneratorContext;
import com.richcoder.mybatis.utils.GeneratorFileUtils;
...
public class DefaultGeneratorStarter implements GeneratorStarter {
  ...
  protected void generator(Set<Generator> generatorSet) {
    ...
    Map<String, String> packageFileSuffixMap = GeneratorFileUtils
        .getAllPackageFileSuffix(packageConfigTypesHashSet);
    ...
    for (String tableName : tableNames) {
      ...
      for (Generator generator : generatorSet) {
        if (typeSet.contains(generator.getPackageConfigTypes().getType().toLowerCase())) {
  ...
  protected GeneratorContext initBaseContext(String tableName,
    ...
    String primaryKey = GeneratorStringUtils
        .firstUpperNoFormat(GeneratorStringUtils.format(propMap.get("primaryKey"), properties));
